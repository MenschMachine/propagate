    ...
    def test_config_loads_and_references_existing_prompt_files(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                'propagate context set :api-docs-branch-name "api-docs/backend-pr-$(propagate context get :source-backend-pr-number | xargs)"',
                "git:branch",
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                'propagate context set :website-branch-name "website/backend-pr-$(propagate context get :source-backend-pr-number --task implement-approved-api-docs-updates | xargs)"',
                "git:branch",
            ],
        )
