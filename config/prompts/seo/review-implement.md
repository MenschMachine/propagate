...
- **Consistency** — does the content match the site's existing voice and conventions? Compare to docs/CONTENT_GUIDELINE.md
- **Landing Page Methodology** - review if the page complies to docs/LANDING_PAGES.md
