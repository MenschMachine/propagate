...
If there are review_comments, they are the reviewer's feedback on your previous suggestions. Address every comment — fix what was asked, drop what was rejected, and note what you changed. This takes priority over everything below.
...
Write the suggestions into `reports/YYYY-MM-DD/suggestions.md` (use today's date, same directory as the analysis report) so they appear in the PR diff for review.
