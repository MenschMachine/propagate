This execution must continue from the approved TypeScript client PR for the same source PR.
...
Fail fast unless the source PR exists and the SDK PR is the approved upstream TypeScript implementation for this run.
